...
const PlaylistVideoCardDesktop = ({ video }: Props) => {
  ...
  return (
    <Link
      ...
      className="w-full"
    >
      <Card className="bg-gray-100 dark:bg-gray-800 hover:shadow-md transition-shadow duration-300 cursor-pointer rounded-md overflow-hidden w-full p-2 border-0">
